...
<api version="1.0">
	<namespace name="Infinity">
		...
		<function name="protocol_get_default_port" symbol="inf_protocol_get_default_port">
		...
		<function name="xml_util_add_child_text" symbol="inf_xml_util_add_child_text">
			<return-type type="void"/>
			<parameters>
				<parameter name="xml" type="xmlNodePtr"/>
		...
		<function name="xml_util_new_node_from_error" symbol="inf_xml_util_new_node_from_error">
			...
			<parameters>
				<parameter name="error" type="GError*"/>
				<parameter name="name_space" type="xmlNsPtr"/>
		...
		<boxed name="InfCertificateChain" type-name="CertificateChain" get-type="inf_certificate_chain_get_type">
		...
		<boxed name="InfCertificateCredentials" type-name="CertificateCredentials" get-type="inf_certificate_credentials_get_type">
		...
		<boxed name="InfChatBufferMessage" type-name="ChatBufferMessage" get-type="inf_chat_buffer_message_get_type">
		...
		<boxed name="InfIpAddress" type-name="IpAddress" get-type="inf_ip_address_get_type">
		...
		<enum name="InfChatBufferMessageType" type-name="ChatBufferMessageType" get-type="inf_chat_buffer_message_type_get_type">
		...
		<enum name="InfIpAddressFamily" type-name="IpAddressFamily" get-type="inf_ip_address_family_get_type">
		...
		<enum name="InfSessionStatus" type-name="SessionStatus" get-type="inf_session_status_get_type">
		...
		<enum name="InfSimulatedConnectionMode" type-name="SimulatedConnectionMode" get-type="inf_simulated_connection_mode_get_type">
			<member name="INF_SIMULATED_CONNECTION_IMMEDIATE" value="0"/>
			<member name="INF_SIMULATED_CONNECTION_DELAYED" value="1"/>
		</enum>
		<enum name="InfTcpConnectionStatus" type-name="TcpConnectionStatus" get-type="inf_tcp_connection_status_get_type">
		...
		<enum name="InfUserStatus" type-name="UserStatus" get-type="inf_user_status_get_type">
		...
		<flags name="InfChatBufferMessageFlags" type-name="ChatBufferMessageFlags" get-type="inf_chat_buffer_message_flags_get_type">
			<member name="INF_CHAT_BUFFER_MESSAGE_BACKLOG" value="1"/>
		</flags>
		<flags name="InfIoEvent" type-name="IoEvent" get-type="inf_io_event_get_type">
			<member name="INF_IO_INCOMING" value="1"/>
			<member name="INF_IO_OUTGOING" value="2"/>
			<member name="INF_IO_ERROR" value="4"/>
		</flags>
		<flags name="InfUserFlags" type-name="UserFlags" get-type="inf_user_flags_get_type">
		...
		<object name="InfChatBuffer" parent="GObject" type-name="ChatBuffer" get-type="inf_chat_buffer_get_type">
			<implements>
			...
			<method name="add_message_" symbol="inf_chat_buffer_add_message">
				<return-type type="void"/>
				<parameters>
					<parameter name="buffer" type="InfChatBuffer*"/>
					<parameter name="by" type="InfUser*"/>
		...
		<object name="InfChatSession" parent="InfSession" type-name="ChatSession" get-type="inf_chat_session_get_type">
			<implements>
		...
		<object name="InfDiscoveryAvahi" parent="GObject" type-name="DiscoveryAvahi" get-type="inf_discovery_avahi_get_type">
			<implements>
		...
		<object name="InfSession" parent="GObject" type-name="Session" get-type="inf_session_get_type">
			<implements>
				<interface name="InfCommunicationObject"/>
			</implements>
			...
			<method name="close_" symbol="inf_session_close">
				<return-type type="void"/>
				<parameters>
					<parameter name="session" type="InfSession*"/>
				</parameters>
		...
		<object name="InfSimulatedConnection" parent="GObject" type-name="SimulatedConnection" get-type="inf_simulated_connection_get_type">
			<implements>
		...
		<object name="InfStandaloneIo" parent="GObject" type-name="StandaloneIo" get-type="inf_standalone_io_get_type">
			<implements>
		...
		<object name="InfTcpConnection" parent="GObject" type-name="TcpConnection" get-type="inf_tcp_connection_get_type">
		...
		<object name="InfUser" parent="GObject" type-name="User" get-type="inf_user_get_type">
		...
		<object name="InfUserTable" parent="GObject" type-name="UserTable" get-type="inf_user_table_get_type">
			<method name="add_user_" symbol="inf_user_table_add_user">
				<return-type type="void"/>
				<parameters>
			...
			<method name="remove_user_" symbol="inf_user_table_remove_user">
				<return-type type="void"/>
				<parameters>
					<parameter name="user_table" type="InfUserTable*"/>
					<parameter name="user" type="InfUser*"/>
		...
		<interface name="InfBuffer" type-name="Buffer" get-type="inf_buffer_get_type">
			<requires>
		...
		<interface name="InfDiscovery" type-name="Discovery" get-type="inf_discovery_get_type">
			<requires>
				<interface name="GObject"/>
			</requires>
			...
			<method name="discovered_" symbol="inf_discovery_discovered">
				<return-type type="void"/>
				<parameters>
					<parameter name="discovery" type="InfDiscovery*"/>
					<parameter name="info" type="InfDiscoveryInfo*"/>
			...
			<method name="undiscovered_" symbol="inf_discovery_undiscovered">
				<return-type type="void"/>
				<parameters>
					<parameter name="discovery" type="InfDiscovery*"/>
					<parameter name="info" type="InfDiscoveryInfo*"/>
		...
		<interface name="InfIo" type-name="Io" get-type="inf_io_get_type">
			<requires>
				<interface name="GObject"/>
			</requires>
		...
		<interface name="InfLocalPublisher" type-name="LocalPublisher" get-type="inf_local_publisher_get_type">
			<requires>
				<interface name="GObject"/>
			</requires>
...
<namespace name="Infinity.Client"><callback name="InfcRequestManagerForeachFunc">
			<return-type type="void"/>
			<parameters>
				<parameter name="p1" type="InfcRequest*"/>
				<parameter name="p2" type="gpointer"/>
			</parameters>
		</callback><struct name="InfcNotePlugin">
			<field name="user_data" type="gpointer"/>
			<field name="note_type" type="gchar*"/>
			<field name="session_new" type="GCallback"/>
		</struct><boxed name="InfcBrowserIter" type-name="BrowserIter" get-type="infc_browser_iter_get_type">
		...
		</boxed><enum name="InfcBrowserNodeStatus">
		...
		</enum><enum name="InfcBrowserStatus" type-name="BrowserStatus" get-type="infc_browser_status_get_type">
		...
		</enum><object name="InfcBrowser" parent="GObject" type-name="Browser" get-type="infc_browser_get_type">
			<implements>
				<interface name="InfCommunicationObject"/>
			</implements>
		...
		</object><object name="InfcExploreRequest" parent="InfcRequest" type-name="ExploreRequest" get-type="infc_explore_request_get_type">
			<method name="finished_" symbol="infc_explore_request_finished">
				<return-type type="gboolean"/>
				<parameters>
					<parameter name="request" type="InfcExploreRequest*"/>
					<parameter name="error" type="GError**"/>
			...
			<method name="initiated_" symbol="infc_explore_request_initiated">
				<return-type type="void"/>
				<parameters>
					<parameter name="request" type="InfcExploreRequest*"/>
			...
			<method name="progress_" symbol="infc_explore_request_progress">
				<return-type type="gboolean"/>
				<parameters>
					<parameter name="request" type="InfcExploreRequest*"/>
					<parameter name="error" type="GError**"/>
		...
		</object><object name="InfcNodeRequest" parent="InfcRequest" type-name="NodeRequest" get-type="infc_node_request_get_type">
			<method name="finished_" symbol="infc_node_request_finished">
				<return-type type="void"/>
				<parameters>
					<parameter name="request" type="InfcNodeRequest*"/>
					<parameter name="iter" type="InfcBrowserIter*"/>
		...
		</object><object name="InfcRequest" parent="GObject" type-name="Request" get-type="infc_request_get_type">
			<method name="failed_" symbol="infc_request_failed">
				<return-type type="void"/>
				<parameters>
		...
		</object><object name="InfcRequestManager" parent="GObject" type-name="RequestManager" get-type="infc_request_manager_get_type">
		...
		</object><object name="InfcSessionProxy" parent="GObject" type-name="SessionProxy" get-type="infc_session_proxy_get_type">
			<implements>
				<interface name="InfCommunicationObject"/>
			</implements>
		...
		</object><object name="InfcUserRequest" parent="InfcRequest" type-name="UserRequest" get-type="infc_user_request_get_type">
			<method name="finished_" symbol="infc_user_request_finished">
				<return-type type="void"/>
				<parameters>
		...
		</object></namespace><namespace name="Infinity.Adopted"><callback name="InfAdoptedStateVectorForeachFunc">
			<return-type type="void"/>
			<parameters>
				<parameter name="id" type="guint"/>
				<parameter name="value" type="guint"/>
		...
		</callback><boxed name="InfAdoptedStateVector" type-name="StateVector" get-type="inf_adopted_state_vector_get_type">
		...
		</boxed><enum name="InfAdoptedConcurrencyId" type-name="ConcurrencyId" get-type="inf_adopted_concurrency_id_get_type">
		...
		</enum><enum name="InfAdoptedRequestType" type-name="RequestType" get-type="inf_adopted_request_type_get_type">
		...
		</enum><enum name="InfAdoptedSessionError">
		...
		</enum><enum name="InfAdoptedSessionReplayError">
		...
		</enum><enum name="InfAdoptedStateVectorError">
			<member name="INF_ADOPTED_STATE_VECTOR_BAD_FORMAT" value="0"/>
			<member name="INF_ADOPTED_STATE_VECTOR_FAILED" value="1"/>
		</enum><flags name="InfAdoptedOperationFlags" type-name="OperationFlags" get-type="inf_adopted_operation_flags_get_type">
			<member name="INF_ADOPTED_OPERATION_AFFECTS_BUFFER" value="1"/>
			<member name="INF_ADOPTED_OPERATION_REVERSIBLE" value="2"/>
		</flags><object name="InfAdoptedAlgorithm" parent="GObject" type-name="Algorithm" get-type="inf_adopted_algorithm_get_type">
		...
		</object><object name="InfAdoptedNoOperation" parent="GObject" type-name="NoOperation" get-type="inf_adopted_no_operation_get_type">
			<implements>
		...
		</object><object name="InfAdoptedRequest" parent="GObject" type-name="Request" get-type="inf_adopted_request_get_type">
		...
		</object><object name="InfAdoptedRequestLog" parent="GObject" type-name="RequestLog" get-type="inf_adopted_request_log_get_type">
			<method name="add_request_" symbol="inf_adopted_request_log_add_request">
				<return-type type="void"/>
				<parameters>
			...
			<method name="next_redo_" symbol="inf_adopted_request_log_next_redo">
				<return-type type="InfAdoptedRequest*"/>
				<parameters>
					<parameter name="log" type="InfAdoptedRequestLog*"/>
				</parameters>
			</method>
			<method name="next_undo_" symbol="inf_adopted_request_log_next_undo">
				<return-type type="InfAdoptedRequest*"/>
				<parameters>
					<parameter name="log" type="InfAdoptedRequestLog*"/>
				</parameters>
		...
		</object><object name="InfAdoptedSession" parent="InfSession" type-name="Session" get-type="inf_adopted_session_get_type">
			<implements>
				<interface name="InfCommunicationObject"/>
			</implements>
			...
			<method name="read_request_info" symbol="inf_adopted_session_read_request_info">
				...
				<parameters>
					...
					<parameter name="operation" type="xmlNodePtr*"/>
					<parameter name="error" type="GError**"/>
				</parameters>
			</method>
		...
		</object><object name="InfAdoptedSessionRecord" parent="GObject" type-name="SessionRecord" get-type="inf_adopted_session_record_get_type">
		...
		</object><object name="InfAdoptedSessionReplay" parent="GObject" type-name="SessionReplay" get-type="inf_adopted_session_replay_get_type">
		...
		</object><object name="InfAdoptedSplitOperation" parent="GObject" type-name="SplitOperation" get-type="inf_adopted_split_operation_get_type">
			<implements>
				<interface name="InfAdoptedOperation"/>
			</implements>
		...
		</object><object name="InfAdoptedUndoGrouping" parent="GObject" type-name="UndoGrouping" get-type="inf_adopted_undo_grouping_get_type">
		...
		</object><object name="InfAdoptedUser" parent="InfUser" type-name="User" get-type="inf_adopted_user_get_type">
		...
		</object><interface name="InfAdoptedOperation" type-name="Operation" get-type="inf_adopted_operation_get_type">
			<requires>
				<interface name="GObject"/>
			</requires>
		...
		</interface></namespace><namespace name="Infinity.Xml"><enum name="InfXmlConnectionStatus" type-name="ConnectionStatus" get-type="inf_xml_connection_status_get_type">
		...
		</enum><interface name="InfXmlConnection" type-name="Connection" get-type="inf_xml_connection_get_type">
			<requires>
				<interface name="GObject"/>
			</requires>
			...
			<method name="error_" symbol="inf_xml_connection_error">
				<return-type type="void"/>
				<parameters>
					<parameter name="connection" type="InfXmlConnection*"/>
					<parameter name="error" type="GError*"/>
			...
			<method name="received_" symbol="inf_xml_connection_received">
				<return-type type="void"/>
				<parameters>
					<parameter name="connection" type="InfXmlConnection*"/>
					<parameter name="xml" type="xmlNodePtr"/>
			...
			<method name="sent_" symbol="inf_xml_connection_sent">
				<return-type type="void"/>
				<parameters>
					<parameter name="connection" type="InfXmlConnection*"/>
					<parameter name="xml" type="xmlNodePtr"/>
		...
		</interface></namespace><namespace name="Infinity.Daemon"><callback name="InfdDirectoryForeachConnectionFunc">
			<return-type type="void"/>
			<parameters>
				<parameter name="p1" type="InfXmlConnection*"/>
				<parameter name="p2" type="gpointer"/>
			</parameters>
		</callback><callback name="InfdServerPoolForeachServerFunc">
			<return-type type="void"/>
			<parameters>
				<parameter name="server" type="InfdXmlServer*"/>
				<parameter name="user_data" type="gpointer"/>
			</parameters>
		</callback><struct name="InfdNotePlugin">
			<field name="user_data" type="gpointer"/>
		...
		</struct><boxed name="InfdDirectoryIter" type-name="DirectoryIter" get-type="infd_directory_iter_get_type">
			...
			<field name="node_id" type="guint"/>
			<field name="node" type="gpointer"/>
		</boxed><boxed name="InfdStorageNode" type-name="StorageNode" get-type="infd_storage_node_get_type">
		...
		</boxed><enum name="InfdFilesystemStorageError">
		...
		</enum><enum name="InfdStorageNodeType" type-name="StorageNodeType" get-type="infd_storage_node_type_get_type">
			<member name="INFD_STORAGE_NODE_SUBDIRECTORY" value="0"/>
			<member name="INFD_STORAGE_NODE_NOTE" value="1"/>
		</enum><enum name="InfdTcpServerStatus" type-name="TcpServerStatus" get-type="infd_tcp_server_status_get_type">
			<member name="INFD_TCP_SERVER_CLOSED" value="0"/>
			<member name="INFD_TCP_SERVER_OPEN" value="2"/>
		</enum><enum name="InfdXmlServerStatus" type-name="XmlServerStatus" get-type="infd_xml_server_status_get_type">
		...
		</enum><object name="InfdDirectory" parent="GObject" type-name="Directory" get-type="infd_directory_get_type">
			<implements>
				<interface name="InfCommunicationObject"/>
			</implements>
		...
		</object><object name="InfdFilesystemStorage" parent="GObject" type-name="FilesystemStorage" get-type="infd_filesystem_storage_get_type">
			<implements>
		...
		</object><object name="InfdServerPool" parent="GObject" type-name="ServerPool" get-type="infd_server_pool_get_type">
		...
		</object><object name="InfdSessionProxy" parent="GObject" type-name="SessionProxy" get-type="infd_session_proxy_get_type">
			<implements>
				<interface name="InfCommunicationObject"/>
			</implements>
		...
		</object><object name="InfdTcpServer" parent="GObject" type-name="TcpServer" get-type="infd_tcp_server_get_type">
		...
		</object><object name="InfdXmppServer" parent="GObject" type-name="XmppServer" get-type="infd_xmpp_server_get_type">
			<implements>
		...
		</object><interface name="InfdStorage" type-name="Storage" get-type="infd_storage_get_type">
			<requires>
				<interface name="GObject"/>
			</requires>
		...
		</interface><interface name="InfdXmlServer" type-name="XmlServer" get-type="infd_xml_server_get_type">
			<requires>
				<interface name="GObject"/>
			</requires>
			...
			<method name="new_connection_" symbol="infd_xml_server_new_connection">
				<return-type type="void"/>
				<parameters>
					<parameter name="server" type="InfdXmlServer*"/>
					<parameter name="connection" type="InfXmlConnection*"/>
		...
		</interface></namespace><namespace name="Infinity.Communication"><enum name="InfCommunicationScope" type-name="Scope" get-type="inf_communication_scope_get_type">
			<member name="INF_COMMUNICATION_SCOPE_PTP" value="0"/>
			<member name="INF_COMMUNICATION_SCOPE_GROUP" value="1"/>
		</enum><object name="InfCommunicationCentralFactory" parent="GObject" type-name="CentralFactory" get-type="inf_communication_central_factory_get_type">
			<implements>
		...
		</object><object name="InfCommunicationCentralMethod" parent="GObject" type-name="CentralMethod" get-type="inf_communication_central_method_get_type">
			<implements>
		...
		</object><object name="InfCommunicationGroup" parent="GObject" type-name="Group" get-type="inf_communication_group_get_type">
		...
		</object><object name="InfCommunicationHostedGroup" parent="InfCommunicationGroup" type-name="HostedGroup" get-type="inf_communication_hosted_group_get_type">
		...
		</object><object name="InfCommunicationJoinedGroup" parent="InfCommunicationGroup" type-name="JoinedGroup" get-type="inf_communication_joined_group_get_type">
		...
		</object><object name="InfCommunicationManager" parent="GObject" type-name="Manager" get-type="inf_communication_manager_get_type">
		...
		</object><object name="InfCommunicationRegistry" parent="GObject" type-name="Registry" get-type="inf_communication_registry_get_type">
		...
		</object><interface name="InfCommunicationFactory" type-name="Factory" get-type="inf_communication_factory_get_type">
			<requires>
				<interface name="GObject"/>
			</requires>
		...
		</interface><interface name="InfCommunicationMethod" type-name="Method" get-type="inf_communication_method_get_type">
			<requires>
				<interface name="GObject"/>
			</requires>
			<method name="add_member_" symbol="inf_communication_method_add_member">
				<return-type type="void"/>
				<parameters>
					<parameter name="method" type="InfCommunicationMethod*"/>
					<parameter name="connection" type="InfXmlConnection*"/>
			...
			<method name="remove_member_" symbol="inf_communication_method_remove_member">
				<return-type type="void"/>
				<parameters>
					<parameter name="method" type="InfCommunicationMethod*"/>
					<parameter name="connection" type="InfXmlConnection*"/>
		...
		</interface><interface name="InfCommunicationObject" type-name="Object" get-type="inf_communication_object_get_type">
			<requires>
				<interface name="GObject"/>
			</requires>
		...
		</interface></namespace><namespace name="Infinity.Xmpp"><callback name="InfXmppConnectionCrtCallback">
			<return-type type="void"/>
			<parameters>
		...
		</callback><enum name="InfXmppConnectionAuthError">
		...
		</enum><enum name="InfXmppConnectionError">
		...
		</enum><enum name="InfXmppConnectionSecurityPolicy" type-name="ConnectionSecurityPolicy" get-type="inf_xmpp_connection_security_policy_get_type">
		...
		</enum><enum name="InfXmppConnectionSite" type-name="ConnectionSite" get-type="inf_xmpp_connection_site_get_type">
			<member name="INF_XMPP_CONNECTION_CLIENT" value="1"/>
			<member name="INF_XMPP_CONNECTION_SERVER" value="0"/>
		</enum><enum name="InfXmppConnectionStreamError">
		...
		</enum><object name="InfXmppConnection" parent="GObject" type-name="Connection" get-type="inf_xmpp_connection_get_type">
			<implements>
				<interface name="InfXmlConnection"/>
			</implements>
		...
		</object><object name="InfXmppManager" parent="GObject" type-name="Manager" get-type="inf_xmpp_manager_get_type">
			<method name="add_connection_" symbol="inf_xmpp_manager_add_connection">
				<return-type type="void"/>
				<parameters>
					<parameter name="manager" type="InfXmppManager*"/>
			...
			<method name="remove-connection_" symbol="inf_xmpp_manager_remove_connection">
				<return-type type="void"/>
				<parameters>
					<parameter name="manager" type="InfXmppManager*"/>
					<parameter name="connection" type="InfXmppConnection*"/>
